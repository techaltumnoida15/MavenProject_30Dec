...
public class CurrencyChange extends BaseClass {
	...
	public void currency() throws InterruptedException {
		...
		driver.get(
				"https://www.cheapoair.com/air/listing?&d1=NYC&r1=LAS&dt1=03/24/2021&d2=LAS&r2=NYC&dt2=03/30/2021&tripType=ROUNDTRIP&cl=ECONOMY&ad=1&se=0&ch=0&infs=0&infl=0");
